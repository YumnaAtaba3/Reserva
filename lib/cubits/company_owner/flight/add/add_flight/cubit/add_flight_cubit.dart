  ...
  Future<void> getFilters() async {
    ...
    try {
      ...
      if (data.statusCode == 200) {
        ...
        emit(AddFlightGotFiltersSuccess());
      } else {
        emit(AddFlightFailure(message: jsonDecode(data.body)["message"]));
      }
    } catch (e) {
      emit(AddFlightFailure(message: e.toString()));
    }
  }
  ...
  void AddFlight({
    ...
    try {
      ...
      if (data.statusCode == 200) {
        ...
        //      enabled;
        print('afterrrrrrr');
        emit(AddFlightSuccess(message: 'sucess'));
      } else {
        print('failureee');
        emit(AddFlightFailure(message: jsonDecode(data.body)["message"]));
      }
      ...
      print('exception');
      emit(AddFlightFailure(message: "something is wrong ..."));
    }
  }
