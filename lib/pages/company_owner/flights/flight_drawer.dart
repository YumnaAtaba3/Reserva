...
import 'package:reserva/pages/company_owner/flights/flight_home.dart';
import 'package:reserva/pages/company_owner/flights/flight_noti.dart';
import 'package:reserva/pages/company_owner/flights/flight_reservations.dart';
import 'package:reserva/pages/company_owner/flights/flight_wallet.dart';
...
class FlightDrawer extends StatefulWidget {
  FlightDrawer({super.key});

  @override
  State<FlightDrawer> createState() => _FlightDrawerState();
}

class _FlightDrawerState extends State<FlightDrawer> {
                ...
                ListTile(
                  leading: Icon(
                      ...
                      color: _selectedIndex == 1
                          ? Colors.blue
                          : Color(0xff085373)),
                  title: Text('Flights', style: AppStyles.styleBold16(context)
                  ),
                  onTap: () {
                    _onItemTapped(1);
                  },
