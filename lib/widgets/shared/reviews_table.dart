...
class ReviewsTable extends StatelessWidget {
  final List<HotelReview> data;

  ReviewsTable({super.key, required this.data});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: DataTable(
        ...
        rows: data.map((HotelReview) {
          return DataRow(cells: [
            DataCell(Text(HotelReview.userName)),
            DataCell(Text(HotelReview.review)),
            /* DataCell(Row(
